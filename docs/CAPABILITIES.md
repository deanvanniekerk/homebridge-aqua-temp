...
The helper then issued its single `Power=0` restoration, acknowledged at **09:20:49.411 UTC**, approximately 64 seconds after the On acknowledgement. Readback at **09:21:51.212 UTC** confirmed Power=0, Power_State=0, Mode=2 and target 30, with all retained targets unchanged, O07=0, Online and fault false. No request remained armed until the separately authorized Heat restoration. A single `Mode=1` command passed preflight at 09:22:52.949 UTC and was acknowledged at **09:22:55.695 UTC**. Final readback at **09:23:57.454 UTC** confirmed Heat/32°C/Off with R01=8 and R03=30 retained. No target command was sent. Compressor frequency was zero in the captured samples; active Auto heating/cooling remains unverified. Owner confirmation of the visible brief On → Off transition remains pending.
